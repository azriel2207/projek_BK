...
@section('sidebar')
    <a href="{{ route('siswa.dashboard') }}" class="block py-3 px-6 hover:bg-blue-700 transition">
    ...
    <a href="{{ route('siswa.catatan.index') }}" class="block py-3 px-6 hover:bg-blue-700 transition">
