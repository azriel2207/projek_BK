...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-8">
        <form method="GET" action="{{ route('koordinator.siswa-list') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('koordinator.siswa-list') }}" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-lg hover:bg-gray-400 transition">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($siswa as $s)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('koordinator.siswa-list.detail', $s->id) }}" class="text-blue-600 hover:text-blue-900 font-medium transition">
